...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_scripts_utility__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_newsfeed_vue__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_event_feed_vue__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_pagination_vue__ = __webpack_require__(10);
 // Aliased via WebPack.
  ...
  new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
    ...
    methods: {
      ...
      refresh: function (pageNumber = 1) {
        ...
        __WEBPACK_IMPORTED_MODULE_2_scripts_utility__["b" /* loadJSON */](query).then(function (results) {
          self.pagination.totalResults = results.count;

          const news = __WEBPACK_IMPORTED_MODULE_2_scripts_utility__["a" /* formatResults */](results.rows, ['created_at'], true);
    ...
    components: {
      'newsfeed': __WEBPACK_IMPORTED_MODULE_3_vue_newsfeed_vue__["a" /* default */],
      'event-feed': __WEBPACK_IMPORTED_MODULE_4_vue_event_feed_vue__["a" /* default */],
      'pagination': __WEBPACK_IMPORTED_MODULE_5_vue_pagination_vue__["a" /* default */]
    },
    created: function () {
      let self = this;
      ...
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_2_scripts_utility__["b" /* loadJSON */](apiPath + newsQuery));
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_2_scripts_utility__["b" /* loadJSON */](apiPath + 'events'));
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_2_scripts_utility__["b" /* loadJSON */](apiPath + 'tags/news'));
      ...
      Promise.all(requestPromises).then(function (results) {
        ...
        const news = __WEBPACK_IMPORTED_MODULE_2_scripts_utility__["a" /* formatResults */](newsResults.rows, ['created_at'], true);

        const events = __WEBPACK_IMPORTED_MODULE_2_scripts_utility__["a" /* formatResults */](eventsResults, ['start_time', 'end_time'], true);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_newsfeed_vue__ = __webpack_require__(19);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5e94a5c9_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_newsfeed_vue__ = __webpack_require__(30);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_newsfeed_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5e94a5c9_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_newsfeed_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "_app/vue/newsfeed.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e94a5c9", Component.options)
  } else {
    hotAPI.reload("data-v-5e94a5c9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c("div", [
    ...
    _c(
      ...
      _vm._l(_vm.newsfeed, function(news, index) {
        return _c("li", { staticClass: "news-list-item" }, [
          _c("article", { staticClass: "news-card" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "news-author" }, [
              _vm._v(_vm._s(news.organization))
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "news-description" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5e94a5c9", esExports)
  }
}
...
Component.options.__file = "_app/vue/event-feed.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6584cbc9", Component.options)
  } else {
    hotAPI.reload("data-v-6584cbc9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c("section", { staticClass: "events-section" }, [
    ...
    _vm.areRemainingEvents
      ? _c(
          ...
          [
            _c("span", { staticClass: "more-events-button-text" }, [
              _vm._v("More Events")
            ]),
            _vm._v(" "),
            _c("span", { staticClass: "icon-plus-for-buttons" })
          ]
        )
      : _vm._e()
  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6584cbc9", esExports)
  }
}
