...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_scripts_global_store__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_scripts_utility__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_newsfeed_vue__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vue_event_feed_vue__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vue_pagination_vue__ = __webpack_require__(10);
 // Aliased via WebPack.
...
(function () {
  ...
  new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
    store: __WEBPACK_IMPORTED_MODULE_3_scripts_global_store__["a" /* store */],
    el: '#news-updates',
    data: function () {
      return {
        news: [],
    ...
    methods: {
      ...
      refresh: function (pageNumber = 1) {
        ...
        __WEBPACK_IMPORTED_MODULE_4_scripts_utility__["b" /* loadJSON */](query).then(function (results) {
          self.pagination.totalResults = results.count;

          const news = __WEBPACK_IMPORTED_MODULE_4_scripts_utility__["a" /* formatResults */](results.rows, ['created_at'], true);
      ...
      clearAll: function () {
        ...
        __WEBPACK_IMPORTED_MODULE_3_scripts_global_store__["a" /* store */].commit('clearFilters');
        console.log(__WEBPACK_IMPORTED_MODULE_3_scripts_global_store__["a" /* store */].state);
      }
    },
    components: {
    ...
    created: function () {
      ...
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_4_scripts_utility__["b" /* loadJSON */](apiPath + newsQuery));
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_4_scripts_utility__["b" /* loadJSON */](apiPath + 'events'));
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_4_scripts_utility__["b" /* loadJSON */](apiPath + 'tags/news'));
      ...
      Promise.all(requestPromises).then(function (results) {
        ...
        const news = __WEBPACK_IMPORTED_MODULE_4_scripts_utility__["a" /* formatResults */](newsResults.rows, ['created_at'], true);

        const events = __WEBPACK_IMPORTED_MODULE_4_scripts_utility__["a" /* formatResults */](eventsResults, ['start_time', 'end_time'], true);
  ...
  return _c("div", [
    ...
    _c(
      ...
      _vm._l(_vm.newsfeed, function(news, index) {
        return _c(
          "li",
          { staticClass: "news-list-item", attrs: { tabindex: "0" } },
          [
