...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_router__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_resource_list_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_pagination_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_js_utility__ = __webpack_require__(12);
 // Aliased via WebPack.
...
(function () {
  ...
  const TopicComponent = {
    ...
    methods: {
      ...
      changePage: function (pageNumber) {
        ...
        __WEBPACK_IMPORTED_MODULE_5_js_utility__["b" /* loadJSON */](apiPath + 'resources' + '?limit=' + this.pagination.resultsPerPage + '&offset=' + offset + '&topic=' + this.tag).then(results => {
          ...
          this.resources = __WEBPACK_IMPORTED_MODULE_5_js_utility__["a" /* formatResults */](results.rows, ['date_published'], false);
        });
    ...
    components: {
      'resource-list': __WEBPACK_IMPORTED_MODULE_3_vue_resource_list_vue__["a" /* default */],
      'pagination': __WEBPACK_IMPORTED_MODULE_4_vue_pagination_vue__["a" /* default */]
    },
    created: function () {
      let self = this;
      ...
      Promise.all(requestPromises).then(function (results) {
        ...
        const resources = __WEBPACK_IMPORTED_MODULE_5_js_utility__["a" /* formatResults */](resourceResults.rows, ['date_published'], false);
  ...
  new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */](TopicComponent);
})();
