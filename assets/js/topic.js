...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_router__ = __webpack_require__(34);
  ...
  new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
    ...
    methods: {
      getQueryString: function (pageNumber) {
        ...
        let queryString = '?limit=' + limit + '&offset=' + offset + '&topic=' + this.tag;
    ...
    created: function () {
      ...
      requestPromises.push(__WEBPACK_IMPORTED_MODULE_3_scripts_utility__["b" /* loadJSON */](resourceQuery));

      Promise.all(requestPromises).then(function (results) {
        const resourceResults = results[0];

        self.resources = __WEBPACK_IMPORTED_MODULE_3_scripts_utility__["a" /* formatResults */](resourceResults.rows, ['date_published'], false);
      });
    },
    delimiters: ["((", "))"]
  });
